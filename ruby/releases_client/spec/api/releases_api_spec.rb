...
# Unit tests for ReleasesClient::ReleasesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReleasesApi' do
  before do
    # run before each test
    @instance = ReleasesClient::ReleasesApi.new
  end
  ...
  # unit tests for get_channel_releases
  # 
  # 
  # @param channel_id 
  # @param [Hash] opts the optional parameters
  # @return [ReleaserChannelReleases]
  describe 'get_channel_releases test' do
    it "should work" do
