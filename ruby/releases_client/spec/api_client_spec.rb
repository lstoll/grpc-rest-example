...
describe ReleasesClient::ApiClient do
  context 'initialization' do
    context 'URL stuff' do
      context 'host' do
        it 'removes http from host' do
          ReleasesClient.configure { |c| c.host = 'http://example.com' }
          expect(ReleasesClient::Configuration.default.host).to eq('example.com')
        end

        it 'removes https from host' do
          ReleasesClient.configure { |c| c.host = 'https://wookiee.com' }
          expect(ReleasesClient::ApiClient.default.config.host).to eq('wookiee.com')
        end

        it 'removes trailing path from host' do
          ReleasesClient.configure { |c| c.host = 'hobo.com/v4' }
          expect(ReleasesClient::Configuration.default.host).to eq('hobo.com')
        end
      end

      context 'base_path' do
        it "prepends a slash to base_path" do
          ReleasesClient.configure { |c| c.base_path = 'v4/dog' }
          expect(ReleasesClient::Configuration.default.base_path).to eq('/v4/dog')
        end
        ...
        it "ends up as a blank string if nil" do
          ReleasesClient.configure { |c| c.base_path = nil }
          expect(ReleasesClient::Configuration.default.base_path).to eq('')
        end
      end
    end
  end
  ...
  describe "#update_params_for_auth!" do
    it "sets header api-key parameter with prefix" do
      ReleasesClient.configure do |c|
        c.api_key_prefix['api_key'] = 'PREFIX'
        c.api_key['api_key'] = 'special-key'
      end

      api_client = ReleasesClient::ApiClient.new

      config2 = ReleasesClient::Configuration.new do |c|
        c.api_key_prefix['api_key'] = 'PREFIX2'
        c.api_key['api_key'] = 'special-key2'
      end
      api_client2 = ReleasesClient::ApiClient.new(config2)
  ...
  describe "timeout in #build_request" do
    let(:config) { ReleasesClient::Configuration.new }
    let(:api_client) { ReleasesClient::ApiClient.new(config) }

    it "defaults to 0" do
      expect(ReleasesClient::Configuration.default.timeout).to eq(0)
  ...
  describe "#deserialize" do
    ...
    it "handles Hash<String, Pet>" do
      ...
      pet = data[:pet]
      expect(pet).to be_instance_of(ReleasesClient::Pet)
  ...
  describe "#build_collection_param" do
    let(:param) { ['aa', 'bb', 'cc'] }
    let(:api_client) { ReleasesClient::ApiClient.new }
